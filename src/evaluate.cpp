...
Value Eval::evaluate(const Position& pos) {
  ...
  else
  {
      ...
      Value psq = Value(eg_value(pos.psq_score()));
      bool classical = abs(psq) * 5 > (850 + pos.non_pawn_material() / 64) * (5 + r50);

      v = classical ? (pos.side_to_move() == WHITE ? psq : -psq) : adjusted_NNUE();
  }
